...
export default function NotificationSettings() {
  ...
  return (
      <div className="p-1.5 md:p-6">
        <h3 className="font-bold text-xl mb-4 text-[#727272]">
          Notification
        </h3>
        <div className="max-w-full mx-auto py-4 bg-white rounded-md">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Message Notifications */}
            <div className="text-inter">
              <h2 className="text-xs md:text-md font-bold text-inter mb-4 text-[#141414]">
            ...
            {/* Email Notifications */}
            <div>
              <h2 className="text-xs md:text-md font-semibold mb-4">Message Notification</h2>
